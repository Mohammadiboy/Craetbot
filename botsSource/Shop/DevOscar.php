...
if(file_exists("sin1.txt")){
$sin1 = file_get_contents("sin1.txt");
}else{
$sin1 = "👤 ثبت سفارش فالور";
}
if(file_exists("SIN2.txt")){
$SIN2 = file_get_contents("SIN2.txt");
}else{
$SIN2 = "🔆 سفارش جدید";
}
...
$line11 = str_replace('SIN2',$SIN2,$line11);
...
$line12 = str_replace('SIN2',$SIN2,$line12);
...
$line13 = str_replace('SIN2',$SIN2,$line13);
...
$line14 = str_replace('SIN2',$SIN2,$line14);
...
$line21 = str_replace('SIN2',$SIN2,$line21);
...
$line22 = str_replace('SIN2',$SIN2,$line22);
...
$line23 = str_replace('SIN2',$SIN2,$line23);
...
$line24 = str_replace('SIN2',$SIN2,$line24);
...
$line31 = str_replace('SIN2',$SIN2,$line31);
...
$line32 = str_replace('SIN2',$SIN2,$line32);
...
$line33 = str_replace('SIN2',$SIN2,$line33);
...
$line34 = str_replace('SIN2',$SIN2,$line34);
...
$line41 = str_replace('SIN2',$SIN2,$line41);
...
$line42 = str_replace('SIN2',$SIN2,$line42);
...
$line43 = str_replace('SIN2',$SIN2,$line43);
...
$line44 = str_replace('SIN2',$SIN2,$line44);
...
$line51 = str_replace('SIN2',$SIN2,$line51);
...
$line52 = str_replace('SIN2',$SIN2,$line52);
...
$line53 = str_replace('SIN2',$SIN2,$line53);
...
$line54 = str_replace('SIN2',$SIN2,$line54);
...
$line61 = str_replace('SIN2',$SIN2,$line61);
...
$line62 = str_replace('SIN2',$SIN2,$line62);
...
$line63 = str_replace('SIN2',$SIN2,$line63);
...
$line64 = str_replace('SIN2',$SIN2,$line64);
...
if(file_exists("data/mmbrsabt12.txt")){
$mmbrsabt12 = file_get_contents("data/mmbrsabt12.txt");
}else{
$mmbrsabt12 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt112.txt")){
$mmbrsabt112 = file_get_contents("data/mmbrsabt112.txt");
}else{
$mmbrsabt112 = "تنظیم نشده";
}
...
if(file_exists("data/mmbrsabt222.txt")){
$mmbrsabt22 = file_get_contents("data/mmbrsabt222.txt");
}else{
$mmbrsabt222 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt32.txt")){
$mmbrsabt32 = file_get_contents("data/mmbrsabt32.txt");
}else{
$mmbrsabt32 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt332.txt")){
$mmbrsabt332 = file_get_contents("data/mmbrsabt332.txt");
}else{
$mmbrsabt332 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt42.txt")){
$mmbrsabt42 = file_get_contents("data/mmbrsabt42.txt");
}else{
$mmbrsabt42 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt442.txt")){
$mmbrsabt442 = file_get_contents("data/mmbrsabt442.txt");
}else{
$mmbrsabt442 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt52.txt")){
$mmbrsabt52 = file_get_contents("data/mmbrsabt52.txt");
}else{
$mmbrsabt52 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt552.txt")){
$mmbrsabt552 = file_get_contents("data/mmbrsabt552.txt");
}else{
$mmbrsabt552 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt62.txt")){
$mmbrsabt62 = file_get_contents("data/mmbrsabt62.txt");
}else{
$mmbrsabt62 = "تنظیم نشده";
}
if(file_exists("data/mmbrsabt662.txt")){
$mmbrsabt662 = file_get_contents("data/mmbrsabt662.txt");
}else{
$mmbrsabt662 = "تنظیم نشده";
}
...
if(file_exists("data/ozvsin6.txt")){
$ozvsin6 = file_get_contents("data/ozvsin6.txt");
}else{
$ozvsin6 = "تنظیم نشده";
}
if(file_exists("data/ozvsin4.txt")){
$ozvsin4 = file_get_contents("data/ozvsin4.txt");
}else{
$ozvsin4 = "تنظیم نشده";
}
if(file_exists("data/ozvsin5.txt")){
$ozvsin5 = file_get_contents("data/ozvsin5.txt");
}else{
$ozvsin5 = "تنظیم نشده";
}
if(file_exists("data/ozvsin3.txt")){
$ozvsin3 = file_get_contents("data/ozvsin3.txt");
}else{
$ozvsin3 = "تنظیم نشده";
}
if(file_exists("data/ozvsin2.txt")){
$ozvsin2 = file_get_contents("data/ozvsin2.txt");
}else{
$ozvsin2 = "تنظیم نشده";
}
if(file_exists("data/ozvsin1.txt")){
$ozvsin1 = file_get_contents("data/ozvsin1.txt");
}else{
$ozvsin1 = "تنظیم نشده";
}
...
$kanalflow = file_get_contents("kanalflow.txt"); //آیدی کانال تبلیغات بدون @
...
elseif($text == "$dok01" and $tc == 'private'){
bot('sendMessage',[
'chat_id'=>$chat_id,
...
'inline_keyboard'=>[
    ...
    [['text'=>"$dok78", 'callback_data'=> 'barziriz']],
],
...
🔍: جهت انجام پیگیری کد پیگیری خودتون رو ارسال نمایید.
...
if($text == "$SIN2" and $tc == 'private'){
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"🎗قصد سفارش چه چیزی را دارید؟",
'parse_mode'=>'MarkDown',
        	'reply_markup'=>$sin98
]); 
}else{
...
elseif($text == "$sin1" and $tc == 'private'){
$truechannel = json_decode(file_get_contents("https://api.telegram.org/bot$token/getChatMember?chat_id=$channel&user_id=$chat_id"));
$tch25 = $truechannel->result->status;
if($tch25 != 'member' and $tch25 != 'creator' and $tch25 != 'administrator' and is_file("channel.txt") and $chat_id != $admin){
bot('sendMessage',[
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"💥 چه نوع فالوری میخواید دوست عزیز؟",
'parse_mode'=>"HTML",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[
['text' => "$ozvsin1", 'callback_data' => "seen$mmbrsabt12"],['text' => "$ozvsin2", 'callback_data' => "seen$mmbrsabt22"]
                    ],
[
['text' => "$ozvsin3", 'callback_data' => "seen$mmbrsabt32"],['text' => "$ozvsin4", 'callback_data' => "seen$mmbrsabt42"]
                    ],
                    [
['text' => "$ozvsin5", 'callback_data' => "seen$mmbrsabt52"],
                    
['text' => "$ozvsin6", 'callback_data' => "seen$mmbrsabt62"]],
                    ],
...
if ($data == "seen$mmbrsabt32") {
$datas1 = json_decode(file_get_contents("data/$chatid/$chatid.json"),true);
$datas1["ted"] = "$mmbrsabt32";
$outjson = json_encode($datas1,true);
file_put_contents("data/$chatid/sabtkasr.txt",$mmbrsabt332);
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
    ...
    } if ($data == "seen$mmbrsabt442") {
$datas1["ted"] = "$mmbrsabt442";
$outjson = json_encode($datas1,true);
file_put_contents("data/$chatid/sabtkasr.txt",$mmbrsabt442);
file_put_contents("data/$chatid/$chatid.json",$outjson);
        $datas1 = json_decode(file_get_contents("data/$chatid/$chatid.json"),true);
        $in = $datas1["coin"];
        if ($in >= "$mmbrsabt442") {
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
    ...
    } if ($data == "seen$mmbrsabt22") {
$datas1["ted"] = "$mmbrsabt22";
$outjson = json_encode($datas1,true);
file_put_contents("data/$chatid/sabtkasr.txt",$mmbrsabt222);
file_put_contents("data/$chatid/$chatid.json",$outjson);
        $datas1 = json_decode(file_get_contents("data/$chatid/$chatid.json"),true);
        $in = $datas1["coin"];
        if ($in >= "$mmbrsabt222") {
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
    ...
    } if ($data == "seen$mmbrsabt12") {
$datas1["ted"] = "$mmbrsabt12";
$outjson = json_encode($datas1,true);
file_put_contents("data/$chatid/sabtkasr.txt",$mmbrsabt112);
file_put_contents("data/$chatid/$chatid.json",$outjson);
        $datas1 = json_decode(file_get_contents("data/$chatid/$chatid.json"),true);
        $in = $datas1["coin"];
        if ($in >= "$mmbrsabt112") {
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
    ...
    } if ($data == "seen$mmbrsabt52") {
$datas1["ted"] = "$mmbrsabt52";
$outjson = json_encode($datas1,true);
file_put_contents("data/$chatid/sabtkasr.txt",$mmbrsabt552);
file_put_contents("data/$chatid/$chatid.json",$outjson);
        $datas1 = json_decode(file_get_contents("data/$chatid/$chatid.json"),true);
        $in = $datas1["coin"];
        if ($in >= "$mmbrsabt552") {
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
    ...
    } if ($data == "seen$mmbrsabt62") {
$datas1["ted"] = "$mmbrsabt62";
$outjson = json_encode($datas1,true);
file_put_contents("data/$chatid/sabtkasr.txt",$mmbrsabt662);
file_put_contents("data/$chatid/$chatid.json",$outjson);
        $datas1 = json_decode(file_get_contents("data/$chatid/$chatid.json"),true);
        $in = $datas1["coin"];
        if ($in >= "$mmbrsabt662") {
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
        ...
        if ($step == "flow2" and $text != "$backsinza") {
...
'chat_id' => "@$kanalflow",
'message_id' => $message_id2,
'text' => "✅سفارش جدیدی در ربات شما ثبت شد.

👤تعداد فالور درخواستی این کاربر: $al

🆔ایدی یوزر کاربر : $text",
])->result->message_id;
bot('sendmessage', [
'chat_id' => "@$chads",
'message_id' => $message_id2,
'text' => "💎جهت تکمیل سفارش بر روی دکمه های شیشه ای های پایین که نمایش به شما داده میشود استفاده کنید.💎

🎗اگر چیزی نمایش نمیدهد باید بروید قسمت دکمه ها و تنظیم نماید.",
'parse_mode'=>"HTML",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [["text"=>"$dok278", 'callback_data' => "takmil-$post_id"]],
[['text'=>"$dokc2",'callback_data'=>"getcoin-$post_id"],["text" => "$dokc5", 'callback_data' => "goz-$post_id"]],
...
file_put_contents("ads/postid/$post_id.txt", $post_id);
file_put_contents("ads/cont/$post_id.txt",$al);
file_put_contents("ads/admin/$post_id.txt",$chat_id);
file_put_contents("ads/seen/$post_id.txt","0");
file_put_contents("ads/user/$post_id.txt","");
$datas["step"] = "free";
...
bot('sendMessage', [
'chat_id' => $chat_id,
'text' => "✅سفارش شما با موفقیت ثبت شد در ربات ما.

🔍 کد پیگیری شما $post_id است.
👤تعداد فالور درخواستی شما: $al
",
'parse_mode'=>'MarkDown',
        	'reply_markup'=>$menu1
            ]);
}
if (strpos($data, "takmil-") !== false) {
$newd = str_replace("takmil-",'',$data);
$fromm_id = $update->callback_query->from->id;
...
'text' => "🔥تکمیل سفارش با موفقیت انجام شد و به مالک سفارش اطلاع رسانی شد🔥",
'show_alert' => false
]);
bot('sendMessage', [
'chat_id' => $ad,
...
👤تعداد ممبر درخواستی این کاربر: $al
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [["text"=>"$dok278", 'callback_data' => "cancel-$post_id"]],
[['text'=>"$dokc2",'callback_data'=>"getcoin-$post_id"],["text" => "$dokc5", 'callback_data' => "goz-$post_id"]],
[["text" => "$dokc6", 'url' => "https://t.me/[*[USERNAME]*]"]],
]])]);}}
$al = $datas["ted"];
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"🔍 کد پیگیری خود را جهت پیگیری ارسال نمایید.
...
bot('SendMessage', [
'chat_id'=>$chat_id,
'text' => "🚫این سفارش وجود ندارد یا پایان یافت یا شما ادمین ان سفارش نیستید.",
'show_alert' => false
]);
}}}
if($data == "home"){
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [['text'=>"🛍 بخش تنظیم فالور 🛍", 'callback_data'=> 'sexwhitflowjon']],
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"💥نام پلن فالور", 'callback_data'=> 'sinzanos'],['text'=>"♻️ تعداد فالور️",'callback_data'=> 'sinzanos'],['text'=>"💎 موجودی نیاز",'callback_data'=> 'sinzanos']],
    [['text'=>"$ozvsin1", 'callback_data'=> 'ozvsin1'],['text'=>"$mmbrsabt12", 'callback_data'=> 'ozvte12'],['text'=>"$mmbrsabt112", 'callback_data'=> 'almasni12']],
        [['text'=>"$ozvsin2", 'callback_data'=> 'ozvsin2'],['text'=>"$mmbrsabt22", 'callback_data'=> 'ozvte22'],['text'=>"$mmbrsabt222", 'callback_data'=> 'almasni22']],
            [['text'=>"$ozvsin3", 'callback_data'=> 'ozvsin3'],['text'=>"$mmbrsabt32", 'callback_data'=> 'ozvte32'],['text'=>"$mmbrsabt332", 'callback_data'=> 'almasni32']],
                [['text'=>"$ozvsin4", 'callback_data'=> 'ozvsin4'],['text'=>"$mmbrsabt42", 'callback_data'=> 'ozvte42'],['text'=>"$mmbrsabt442", 'callback_data'=> 'almasni42']],
                    [['text'=>"$ozvsin5", 'callback_data'=> 'ozvsin5'],['text'=>"$mmbrsabt52", 'callback_data'=> 'ozvte52'],['text'=>"$mmbrsabt552", 'callback_data'=> 'almasni52']],
                        [['text'=>"$ozvsin6", 'callback_data'=> 'ozvsin6'],['text'=>"$mmbrsabt62", 'callback_data'=> 'ozvte62'],['text'=>"$mmbrsabt662", 'callback_data'=> 'almasni62']],
],
"resize_keyboard"=>true,'one_time_keyboard' => true,
])
]); 
...
'inline_keyboard'=>[
    ...
    [['text'=>"⚙️کانال اطلاع رسانی", 'callback_data'=> 'chaetela'],['text'=>"🎈کانال تبلیغات ممبر", 'callback_data'=> 'chatabli']],
    [['text'=>"👤 کانال تبلیغات فالور", 'callback_data'=> 'mrkanalflow']],
],
"resize_keyboard"=>true,'one_time_keyboard' => true,
])
]); 
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [['text'=>"$SIN2", 'callback_data'=> 'SIN2S'],['text'=>"$sin1",'callback_data'=> 'sin1s']],
    [['text'=>"دکمه بازگشت", 'callback_data'=> "backbut"],['text'=>"$dok0",'callback_data'=> 'pihdok']],
    [['text'=>"$dok547",'callback_data'=> 'pigsef'],['text'=>"$mrsinzaips",'callback_data'=> 'mrsinzais']],
    ...
    [['text'=>"$dok44", 'callback_data'=> 'poshshe'],['text'=>"$dok01",'callback_data'=> 'bardok']],
    ...
    [['text'=>"👥زیرمجموعه", 'callback_data'=> 'zirsheb']],
],
"resize_keyboard"=>true,'one_time_keyboard' => true,
])
]); 
...
elseif($step == "SIN2TEXT" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){
	$datas["step"] = "none";
	$outjson = json_encode($datas,true);
	file_put_contents("data/$from_id/$from_id.json",$outjson);
	if($text == '0'){
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
		...
		file_put_contents("SIN2.txt",$text);
		bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>" $text تنظیم شد.",
'parse_mode'=>'MarkDown',
...
elseif($data == "sin1s"){
	...
	if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
		...
		bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"دکمه سفارش فالور را ارسال کنید
جهت حذف دکمه 0 را ارسال کنید.",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
...
elseif($step == "SIN1TEXT" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){
	$datas["step"] = "none";
	$outjson = json_encode($datas,true);
	file_put_contents("data/$from_id/$from_id.json",$outjson);
	if($text == '0'){
		...
		bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"دکمه سفارش فالور با موفقیت حذف شد.",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
		...
		file_put_contents("sin1.txt",$text);
		bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>" $text تنظیم شد.",
'parse_mode'=>'MarkDown',
...
elseif($data == "mrkanalflow"){
    $chat_id = $update->callback_query->message->chat->id;
    $from_id = $update->callback_query->message->chat->id;
  if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
    $datas["step"] = "mrsinzakanalflow";
    $outjson = json_encode($datas,true);
    file_put_contents("data/$from_id/$from_id.json",$outjson);
    bot('sendMessage',[
'chat_id'=>$chat_id,
...
elseif($step == "mrsinzakanalflow" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){
  $datas["step"] = "none";
  $outjson = json_encode($datas,true);
  file_put_contents("data/$from_id/$from_id.json",$outjson);
  if($text == '0'){
    unlink("kanalflow.txt");
    bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"چنل تبلیغات حذف شد.",
'parse_mode'=>"MarkDown",
...
"resize_keyboard"=>true,'one_time_keyboard' => true,
    ...
    file_put_contents("kanalflow.txt",$text);
    bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>" @$text تنظیم شد.",
'parse_mode'=>'MarkDown',
...
elseif($data == "ozvte12"){
    ...
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh12";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان فالور پلان اول را ارسال نمایید

میزان فعلی : $mmbrsabt12",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh12" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt12.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان فالور پلان دوم را ارسال نمایید
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان فالور پلان سوم را ارسال نمایید

میزان فعلی : $mmbrsabt32",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh32" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt32.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "ozvte42"){
    ...
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh42";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان فالور پلان چهارم را ارسال نمایید

میزان فعلی : $mmbrsabt42",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh42" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt42.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "ozvte52"){
    ...
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh52";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان فالور پلان پنجم را ارسال نمایید

میزان فعلی : $mmbrsabt52",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh52" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt52.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "ozvte62"){
    ...
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh62";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان فالور پلان ششم را ارسال نمایید

میزان فعلی : $mmbrsabt62",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh62" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt62.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "almasni12"){
$chat_id = $update->callback_query->message->chat->id;
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh112";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای سفارش فالور پلان 1 را ارسال نمایید

میزان فعلی : $mmbrsabt112",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh112" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt112.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "almasni22"){
$chat_id = $update->callback_query->message->chat->id;
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh222";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای سفارش فالور پلان 2 را ارسال نمایید

میزان فعلی : $mmbrsabt222",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh222" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt222.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای سفارش فالور پلان 3 را ارسال نمایید

میزان فعلی : $mmbrsabt332",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh332" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt332.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای سفارش فالور پلان 4 را ارسال نمایید

میزان فعلی : $mmbrsabt442",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh442" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt442.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "almasni52"){
$chat_id = $update->callback_query->message->chat->id;
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh552";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای سفارش فالور پلان 5 را ارسال نمایید

میزان فعلی : $mmbrsabt552",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh552" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt552.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($data == "almasni62"){
$chat_id = $update->callback_query->message->chat->id;
    $from_id = $update->callback_query->message->chat->id;
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "psefatesh662";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای سفارش فالور پلان 6 را ارسال نمایید

میزان فعلی : $mmbrsabt662",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
elseif($step == "psefatesh662" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private' and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/mmbrsabt662.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"با موفقیت ثبت شد
...
elseif($step == "ozvsin6" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/ozvsin6.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"تنظیم شد!",
'parse_mode'=>'MarkDown',
...
elseif($step == "ozvsin5" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/ozvsin5.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"تنظیم شد!",
'parse_mode'=>'MarkDown',
...
elseif($step == "ozvsin4" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/ozvsin4.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"تنظیم شد!",
'parse_mode'=>'MarkDown',
...
elseif($step == "ozvsin3" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/ozvsin3.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"تنظیم شد!",
'parse_mode'=>'MarkDown',
...
elseif($step == "ozvsin2" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/ozvsin2.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"تنظیم شد!",
'parse_mode'=>'MarkDown',
...
elseif($step == "ozvsin1" and $text != "🔝ورود به پنل مدیریت🔝" and $tc == 'private'){ 
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$datas["step"] = "free";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/ozvsin1.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"تنظیم شد!",
'parse_mode'=>'MarkDown',
