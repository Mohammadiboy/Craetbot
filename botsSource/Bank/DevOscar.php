...
[['text'=>"کد هدیه 🎉"],['text'=>"مبادلات 🏦"],['text'=>"بخش برداشت 🔥"]],
...
SendMessage("$chat_id","
🏆 برترین کاربران در برداشت موجودی 🏆

🥇نـفـر اول  
♾ شماره کاربری : $user_view_11s
📇تعداد برداشت موجودی : $mojodi_view_11s

🥈نـفـر دوم 
♾ شماره کاربری : $user_view_22s
📇تعداد برداشت موجودی : $mojodi_view_22s

🥉نـفـر سـوم 
♾ شماره کاربری : $user_view_33s
📇تعداد برداشت موجودی : $mojodi_view_33s

🏅نفر چهارم 
♾ شماره کاربری : $user_view_44s
📇تعداد برداشت موجودی : $mojodi_view_44s

🏅نفر پنجم 
♾ شماره کاربری : $user_view_55s
📇تعداد برداشت موجودی : $mojodi_view_55s

🏅نفر ششم 
♾ شماره کاربری : $user_view_66s
📇تعداد برداشت موجودی : $mojodi_view_66s

🏅نفر هفتم 
♾ شماره کاربری : $user_view_77s
📇تعداد برداشت موجودی : $mojodi_view_77s

🏅نفر هشتم 
♾ شماره کاربری : $user_view_88s
📇تعداد برداشت موجودی : $mojodi_view_88s

🏅نفر نهم 
♾ شماره کاربری : $user_view_99s
📇تعداد برداشت موجودی : $mojodi_view_99s

🏅نفر دهم 
♾ شماره کاربری : $user_view_1010s
📇تعداد برداشت موجودی :$mojodi_view_1010s
...
if($text == "$bar3" and $tc == 'private'){
$datas["step"] = "movings765";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
file_put_contents("data/$chat_id/noerobotmorednazar.txt",$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"🔥 قصد برداشت چقدر از موجودی خود را دارید؟

✅ هر یک امتیاز موجودی ربات انتخابی شما: $mmbrsabt33",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
if($step == "movings765" and $text != "/start" and $text != "$backsinza" and $text != "$chat_id" and $tc == 'private'){ 
...
$coinniazs = $textkarbarikon * $mmbrsabt33;
    if ($coinshomahastesh >= $coinniazs) {
$datas["step"] = "seen2";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
		SendMessage($chat_id,"🆔 عددی یا کاربری خود را لطفا ارسال نمایید.

✅شما برای دیگران هم میتونید سفارش ثبت کنید.");
...
✅ هر یک امتیاز موجودی ربات انتخابی شما: $mmbrsabt44",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
if($step == "movings76556" and $text != "/start" and $text != "$backsinza" and $text != "$chat_id" and $tc == 'private'){ 
    if(preg_match("/^(-){0,1}([0-9]+)(,[0-9][0-9][0-9])*([.][0-9]){0,1}([0-9]*)$/",$text)){
 $textkarbarikon = (abs($text));
 file_put_contents("data/$chat_id/tedadtarkhastishes.txt",$text);
...
file_put_contents("data/$chatid/$chatid.json",$outjson);
        ...
        $coinshomahastesh = $datas["coin"];
$coinniazs = $textkarbarikon * $mmbrsabt44;
    if ($coinshomahastesh >= $coinniazs) {
$datas["step"] = "seen2";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
...
✅ هر یک امتیاز موجودی ربات انتخابی شما: $mmbrsabt22",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
file_put_contents("data/$chatid/$chatid.json",$outjson);
        ...
        $coinshomahastesh = $datas["coin"];
$coinniazs = $textkarbarikon * $mmbrsabt22;
    if ($coinshomahastesh >= $coinniazs) {
$datas["step"] = "seen2";
$outjson = json_encode($datas,true);
file_put_contents("data/$from_id/$from_id.json",$outjson);
...
✅ هر یک امتیاز موجودی ربات انتخابی شما: $mmbrsabt11",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
$noerobotmorednazar = file_get_contents("data/$from_id/noerobotmorednazar.txt");
$post_id = bot('sendmessage', [
'chat_id' => "@$chads",
'message_id' => $message_id2,
'text' => "💎 برداشت موجودی توسط کاربر $chat_id انجام شد.

🛍 موجودی درخواستی: $tedadtarkhastishes
🤖 نوع ربات درخواستی: $noerobotmorednazar

🆔 عددی کاربر جهت واریز موجودی: $text",
])->result->message_id;
bot('sendmessage', [
'chat_id' => "@$chads",
'message_id' => $message_id2,
...
💎 بزودی برای شما واریز میشود و پیام اطلاع واریزی برای شما ارسال میشود.

🔍  کد پیگیری سفارش شما جهت پیگیری : $post_id
",
'parse_mode'=>'MarkDown',
        	'reply_markup'=>$menu1
            ]);
...
bot('sendMessage', [
'chat_id' => $ad,
'text' => "✅ موجودی شما با موفقیت واریز شد با تشکر از اعتماد شما.",
'parse_mode' => "html"
]);
@$enn = file_get_contents("data/enf.txt");
$getenf = $enn + 1;
...
—————————————————————————————-
تعداد موجودی سفارش داده : $co
تعداد موجودی دریافتی : $end
—————————————————————————————-",
'parse_mode'=>'Markdown', 
'reply_markup'=>json_encode([ 
'resize_keyboard'=>true,
...
elseif($text == "بخش برداشت 🔥" and $tc == 'private'){	
if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
$alluser = file_get_contents("data/ozvs.txt");
$alaki = explode("\n",$alluser);
$allusers = count($alaki);
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [['text'=>"Ⓜ️وضعیت برداشت موجودیⓂ️", 'callback_data'=> 'sinzanos']],
     [['text'=>"✅روشن شدن", 'callback_data'=> 'roshsef'],['text'=>"📛خاموش شدن️",'callback_data'=> 'khamsef'],['text'=>"💬متن خاموشی سفارش️️", 'callback_data'=> 'matkham']],
            [['text'=>"🔱بخش برداشت موجودی🔱", 'callback_data'=> 'kosnanatkomidacjw']],
    [['text'=>"👤نام پلن ها", 'callback_data'=> 'sinzanos'],['text'=>"💎$almasbot نیاز️",'callback_data'=> 'sinzanos']],
    [['text'=>"$bar1", 'callback_data'=> 'ozvname1'],['text'=>"$mmbrsabt11", 'callback_data'=> 'almasni1']],
        [['text'=>"$bar2", 'callback_data'=> 'ozvname2'],['text'=>"$mmbrsabt22", 'callback_data'=> 'almasni2']],
            [['text'=>"$bar3", 'callback_data'=> 'ozvname3'],['text'=>"$mmbrsabt33", 'callback_data'=> 'almasni3']],
                [['text'=>"$bar4", 'callback_data'=> 'ozvname4'],['text'=>"$mmbrsabt44", 'callback_data'=> 'almasni4']],
],
"resize_keyboard"=>true,'one_time_keyboard' => true,
])
]); 
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [['text'=>"چیدمان 🌐⌨️",'callback_data'=> 'chebotss']],
    ...
    [['text'=>"💎دارای $almasbot", 'callback_data'=> 'barshe'],['text'=>"🎉ثبت موجودی",'callback_data'=> 'sabsheb']],
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"دکمه برداشت موجودی جدید را ارسال کنید
جهت حذف دکمه 0 را ارسال کنید.",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"دکمه برداشت موجودی جدید با موفقیت حذف شد.",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'keyboard'=>[
...
file_put_contents("viewbot.txt","off");
        bot('sendmessage', [
                'chat_id' =>$chat_id,
                'text' =>"برداشت موجودی غیر فعال شد",
        'reply_to_message_id' => $message_id,
               'parse_mode'=>'html',
  ]);
}else{
...
elseif($data == "sefshe"){
	...
	if ($chat_id == $admin or $chat_id == $admin2 or $chat_id == $admin3 or $chat_id == $admin4 or $chat_id == $admin5) {
		...
		bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"دکمه برداشت موجودی را ارسال کنید
جهت حذف دکمه 0 را ارسال کنید.",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای برداشت موجودی پلان 1 را ارسال نمایید
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای برداشت موجودی پلان 2 را ارسال نمایید
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای برداشت موجودی پلان 3 را ارسال نمایید
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای برداشت موجودی پلان 4 را ارسال نمایید
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای برداشت موجودی پلان 5 را ارسال نمایید
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"میزان $almasbot لازم برای برداشت موجودی پلان 6 را ارسال نمایید
