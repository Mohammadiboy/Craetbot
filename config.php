...
ob_start();
define('API_KEY','7845411847:AAF23142aJzVjTLLqf_qqaCI9lZRW5j6pt8'); //توکن قرار دهید
$Dev = 7712384524;
$channel = "MohammadiBots";  //ایدی چنل
$botuser = "MHBotCreatorBot"; //یوزرنیم بات
$idbot = "https://t.me/MHBotCreatorBot"; //ایدی ربات خود
$folder = "https://53c7-103-23-36-53.ngrok-free.app"; // دامنه و ادرس فایل
//-------------------------------فانکشن ها---------------------------------------------
